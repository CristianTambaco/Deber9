    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Divider(),
          _buildTotalRow('Total', totales['total']!, bold: true, color: Colors.green),
        ],
      ),
    );
  }

  Widget _buildTotalRow(String label, double valor, {bool bold = false, Color? color}) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text('\$${valor.toStringAsFixed(2)}', style: TextStyle(fontWeight: bold ? FontWeight.bold : FontWeight.normal, color: color)),
        ],
      ),
    );
  }
